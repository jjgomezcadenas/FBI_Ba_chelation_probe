...
Neutrinos are the only elementary particles that could be their own antiparticles\cite{Majorana:1937}. This could be established experimentally by observing neutrinoless double beta decays in a number of isotopes\cite{GomezCadenas:2010gs}. Experiments attempting to see this rare reaction must suppress by many orders of magnitude the huge background associated to natural radioactivity. Xenon-based Time Projection Chambers (TPCs) could achieve this feat by identifying --``tagging"-- the  daughter \Bapp\ ion produced in the decay\cite{Moe:1991ik,Nygren_2015, Jones:2016qiq, McDonald:2017izm, Chambers:2018srx}. In particular, the use of a fluorescent bicolour indicator (FBI) has been recently proposed as the building block of a barium tagging sensor\cite{rivilla_fluorescent_2020}. Here we use a combination of surface science techniques to \completar{characterize the sensing capability of FBI supramolecular complexes from single molecules to monolayers} \sout{measure the formation of supramolecular complexes in monolayers of FBI sensors} under ultra-high vacuum conditions, thus unambiguously demonstrating the feasibility of the FBI chemical entity to capture and identify \Bapp\ ions. 
...
\begin{figure*}[ht!]
	\includegraphics[width=0.9\textwidth]{figures/fig2_xps_chelation.2.pdf}
